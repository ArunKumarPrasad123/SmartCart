...
import { authDataContext } from '../admincontext/AuthContext';
import { adminDataContext } from '../admincontext/AdminContext';
...
function Login() {
  ...
  return (
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
       ...
       <h1 className='text-[22px] font-sans '>SmartCart</h1>
       </div>
   
       <div className='w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]'>
           <span className='text-[25px] font-semibold'>Login Page</span>
           <span className='text-[16px]'>Welcome to SmartCart, Apply to Admin Login</span>
